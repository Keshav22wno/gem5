...
# or probably SrcClockDoamin(), VoltageDomain(), AddrRange() are not sim objects
system=System()
...
# ports being connected by equal sign. pybind will take care of this
system.cpu.icache_port=system.memobj.inst_port
system.cpu.dcache_port=system.memobj.data_port

system.membus=SystemXBar()

# cpu_side_ports are called vector response ports
